 ...
 */
final class Version20180529233516 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre_id INT NOT NULL, DROP librarysection, DROP genre');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD genre INT NOT NULL, CHANGE genre_id librarysection INT NOT NULL');
